...
def OdeintAdjointMethod(*args):
    ...
    y0, t, flat_params, rtol, atol = args[:-4], args[-4], args[-3], args[-2], args[-1]
    ...
    def grad(*grad_output, variables=None):
        ...
        def augmented_dynamics(t, y_aug):
            ...
            # print('vjp_params', [v.numpy().shape for v in vjp_params])
        ...
        model_vars = list((variables, adj_params))

        grad_vars = adj_y_grad_vars + time_grad_vars + model_vars
